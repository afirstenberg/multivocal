...
var IsNull = {
  JustUndefined: val => typeof val === 'undefined',
  Falsey: val => !val
};
exports.IsNull = IsNull;

var objPathsDefault = function( obj, paths, def, isNull ){
  if( typeof isNull !== 'function' ){
    isNull = IsNull.JustUndefined;
  }
...
var pathSetting = function( env, pathOfSetting ){
  ...
  var settingIsNullPath  = `${pathOfSetting}/IsNull`;
  var settingIsNullName = setting( env, settingIsNullPath );
  var settingIsNull = settingIsNullName && IsNull[settingIsNullName];

  var paths = setting( env, settingPath, Template.Methods.Array );
  var ret = objPathsDefault( env, paths, undefined, settingIsNull );
