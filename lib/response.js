...
var getFromSettings = function( env, settingPath ){
  ...
  return get( env, responseNames, responseField, responseBase, templateResponseMap );
};
...
var get = function( env, responseNames, responseField, responseDefault, templateResponseMap ){
