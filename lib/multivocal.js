...
var loadVoice = function( env ){
  ...
  env.Voices = voices;
  console.log('loadVoice voices',voices);
  if( env.RequestedVoiceName ){
    env.Voice = voices[env.RequestedVoiceName];
    env.Voice.Name = env.RequestedVoiceName;
  ...
  if( !env.Voice ){
    ...
    console.log('loadVoice',{index,name});
    env.Voice = voices[name];
    env.Voice.Name = name;
  }
