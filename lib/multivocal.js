...
handlers['Action.multivocal.welcome'] = handleActionWelcome;
...
handlers['Action.multivocal.repeat'] = handleActionRepeat;
...
handlers['Action.multivocal.quit'] = handleActionQuit;
...
var sendMessage = function( env ){
  return sendMessageContent( env, 'Ssml' )
    .then( env => sendMessageContent( env, 'Text' ) )
